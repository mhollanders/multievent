...
Data and code to analyse the *M. fleayi* data are available on Dryad ([https://doi.org/10.5061/dryad.s7h44j19h](https://doi.org/10.5061/dryad.s7h44j19h)); they are also available, along with appendix files, on GitHub ([https://github.com/mhollanders/multievent](https://github.com/mhollanders/multievent)).
